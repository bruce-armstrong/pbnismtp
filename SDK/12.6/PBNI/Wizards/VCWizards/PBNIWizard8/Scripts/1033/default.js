...
function AddConfig(proj, strProjectName)
{
   try
   {
      ...
      CLTool.UsePrecompiledHeader = pchNone; //pchGenerateAuto was discarded in VS2005;
      ...
      //if (nUnicodeSupport != 0)
      //{      
         CLTool.AdditionalIncludeDirectories = "\"C:\\sybase\\PowerBuilder 11.0\\SDK\\PBNI\\include\"";
     //}
      //else
      //{
